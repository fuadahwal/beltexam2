...
class UserManager(models.Manager):
    ...
    def register(self, reg_data):
        ...
        return (False,"oops, something didnt match there please try again using only letters in name and username and double check your password")
